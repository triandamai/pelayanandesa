...
include"koneksi.php";
$e=$_GET['id'];
$edit=mysqli_query($koneksi,"SELECT * FROM tbl_kehilangan WHERE id_kehilangan='$e'")or die(mysqli_error());
...
EDIT SURAT PENGANTAR KEHILANGAN
</div>
<form action="?module=e_kehilangan" method="post" enctype="multipart/form-data">
 		<input type="hidden" name="id_kehilangan" class="form-control" value =" <?php  echo $book['id_kehilangan'];?>">
