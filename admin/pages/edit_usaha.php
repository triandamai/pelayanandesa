...
include"koneksi.php";
$e=$_GET['id'];
$edit=mysqli_query($koneksi,"SELECT * FROM tbl_usaha WHERE id_usaha='$e'")or die(mysqli_error());
...
<form action="?module=e_usaha" method="post" enctype="multipart/form-data">
 		<input type="hidden" name="id_usaha" class="form-control" value =" <?php  echo $book['id_usaha'];?>">
		...
		<b>Jenis Usaha : </b><input type="text" name="jenis_usaha" class="form-control" value =" <?php  echo $book['jenis_usaha'];?>"><br>
