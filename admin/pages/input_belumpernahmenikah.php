<div id="page-wrapper">
	...
	TAMBAH SURAT KETERANGAN BELUM PERNAH MENIKAH
	</div>
	<form method="post" class="form-group" action="tambah_belumpernahmenikah.php" enctype="multipart/form-data" style="margin-top:20px;">
	<p>
		<b>
			Yang bertanda tangan di bawah ini Kepala Desa Lumbir Kecamatan Lumbir dengan ini menerangkan bahwa :
		</b>
	</p>
		...
		<td>
			<select name="jenis_kelamin" placeholder="Jenis Kelamin" class="form-control">
