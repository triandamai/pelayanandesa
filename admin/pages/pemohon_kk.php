		<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">SURAT KETERANGAN PEMOHON KARTU KELUARGA</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
include"koneksi.php";
$no = 1;
$qry_pemohon_kk = mysqli_query($koneksi,"SELECT * from tbl_kk");
?>
...
<b>DATA SURAT KETERANGAN PEMOHON KARTU KELUARGA</b>
</div>
<a href="?module=input_pemohon_kk" class="btn btn-success" style="margin-top:20px;"><span class="glyphicon glyphicon-plus"> TAMBAH SURAT KETERANGAN PEMOHON KARTU KELUARGA</span></a>
<?php
@$aksi = $_GET['aksi'];
if($aksi=="input")
{
	include("?module=input_pemohon_kk");
}
?>
<div class="th">
<table class="table table-bordered" style="margin-top:20px;">
	...
	<?php while($data = mysqli_fetch_array($qry_pemohon_kk)) { ?>
	<tr>
	 <td><?php echo $no++ ?></td>
	 ...
	 <td><a href="?module=edit_pemohon_kk&id=<?php echo $data['id_pemohon_kk']; ?>"><span class="glyphicon glyphicon-pencil"></span></a>  <a href="hapus_pemohon_kk.php?id=<?php echo $data['id_pemohon_kk']; ?>"><span class="glyphicon glyphicon-trash"></span></a>  <a href="print_pemohon_kk.php?id=<?php echo $data['id_pemohon_kk']; ?>" target="_blank"><span class="glyphicon glyphicon-print"></span></a></td>
	</tr>
	<?php } ?>
</table>
</div>
