	...
	<form method="post" class="form-group" action="tambah_kematian.php" enctype="multipart/form-data" style="margin-top:20px;">
	<p><b>Dengan ini menerangkan bahwa :</b></p>
		...
		<input type="date" name="tgl_meninggal" placeholder="Tanggal Meninggal" class="form-control"><br>
		<input type="text" name="tmp_kematian" placeholder="Tempat Kematian" class="form-control"><br>
		<input type="text" name="sebab_kematian" placeholder="Sebab Kematian" class="form-control"><br>
