...
include"koneksi.php";
$e=$_GET['id'];
$edit=mysqli_query($koneksi,"SELECT * FROM tbl_pemohon_kk WHERE id_pemohon_kk='$e'")or die(mysqli_error());
...
EDIT SURAT KETERANGAN PEMOHON KARTU KELUARGA
</div>
<form action="?module=e_pemohon_kk" method="post" enctype="multipart/form-data">
 		<input type="hidden" name="id_pemohon_kk" class="form-control" value =" <?php  echo $book['id_pemohon_kk'];?>">
