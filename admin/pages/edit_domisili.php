...
include"koneksi.php";
$e=$_GET['id'];
$edit=mysqli_query($koneksi,"SELECT * FROM tbl_domisili WHERE id_domisili='$e'")or die(mysqli_error());
...
<form action="?module=e_domisili" method="post" enctype="multipart/form-data">
 		<input type="hidden" name="id_domisili" class="form-control" value =" <?php  echo $book['id_domisili'];?>">
