        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">PENGANTAR IJIN KHAJATAN</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
include"koneksi.php";
$e=$_GET['id'];
$edit=mysqli_query($koneksi,"SELECT * FROM tbl_ijin_khajatan WHERE id_ijin_khajatan='$e'")or die(mysqli_error());
...
EDIT PENGANTAR IJIN KHAJATAN
</div>
<form action="?module=e_ijin_khajatan" method="post" enctype="multipart/form-data">
 		<input type="hidden" name="id_ijin_khajatan" class="form-control" value =" <?php  echo $book['id_ijin_khajatan'];?>">
<p><b>Dengan ini menerangkan bahwa :</b></p>
		...
		<b>Masa Berlaku : </b><input type="date" name="masa_berlaku" class="form-control" value =" <?php  echo $book['masa_berlaku'];?>"><br>
