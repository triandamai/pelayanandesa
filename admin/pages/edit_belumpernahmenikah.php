        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">KETERANGAN BELUM PERNAH MENIKAH</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
include"koneksi.php";
$e=$_GET['id'];
$edit=mysqli_query($koneksi,"SELECT * FROM tbl_belumpernahmenikah WHERE id_belumpernahmenikah='$e'")or die(mysqli_error());
...
EDIT KETERANGAN BELUM PERNAH MENIKAH
</div>
<form action="?module=e_belumpernahmenikah" method="post" enctype="multipart/form-data">
 		<input type="hidden" name="id_belumpernahmenikah" class="form-control" value =" <?php  echo $book['id_belumpernahmenikah'];?>">
