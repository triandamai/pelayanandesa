...
include "koneksi.php"; 
include "tglindo.php"; 
$d = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_kelahiran where id_kelahiran='$_GET[id]'"));
?>
...
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$d[id_kelahiran]"; ?>-DS-IX-2019</p></td>
</tr> 
</table>
