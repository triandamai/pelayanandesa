	...
	<form method="post" class="form-group" action="tambah_usaha.php" enctype="multipart/form-data" style="margin-top:20px;">
	<p><b>Dengan ini menerangkan bahwa :</b></p>
		...
		<input type="text" name="jenis_usaha" placeholder="Jenis Usaha" class="form-control"><br>
